...
import { CHAINVERSE_TOKENS } from '../tokens/mainnet/chainverse-tokens';
import { DEFIVERSE_TOKENS } from '../tokens/mainnet/defiverse-tokens';
import { ETHEREUM_TOKENS } from '../tokens/mainnet/ethereum-tokens';
import { HOMEVERSE_TOKENS } from '../tokens/mainnet/homeverse-tokens';
import { MCHVERSE_TOKENS } from '../tokens/mainnet/mchverse-tokens';
import { POLYGON_TOKENS } from '../tokens/mainnet/polygon-tokens';
import { SAKUURU_TOKENS } from '../tokens/mainnet/sakuuru-tokens';
import { TCGVERSE_TOKENS } from '../tokens/mainnet/tcgverse-tokens';
